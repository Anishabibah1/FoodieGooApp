...
import '../../features/driver/data/datasources/driver_websocket_datasource.dart';
import '../../features/driver/domain/usecases/get_tracking_stream.dart';
...
void setupDependencies() {
  ...
  sl.registerLazySingleton<DriverWebSocketDataSource>(
    () => DriverWebSocketDataSource(),
  );
  sl.registerLazySingleton<GetTrackingStreamUseCase>(
    () => GetTrackingStreamUseCase(sl()),
  );
